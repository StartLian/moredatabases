...
@Configuration
@MapperScan(basePackages = "com.jessica.moredatabases.mapper.db1dao", sqlSessionFactoryRef = "db1SqlSessionFactory")
...
//        bean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath*:mapping/db1/*.xml"));
        bean.setTypeAliasesPackage("com.jessica.moredatabases.db1dao");
